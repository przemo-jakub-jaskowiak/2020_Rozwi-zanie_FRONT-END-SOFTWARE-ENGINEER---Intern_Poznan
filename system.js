...
const displayPokemon = (pokemon) => {
    ...
    const pokemonHTMLString = pokemon.map(pokeman => `<li class="card" onclick="selectPokemon(${pokeman.id})">
...
var ball = document.querySelector(".poke");

function loke() {
    this.classList.toggle('move')

}
ball.addEventListener('click', loke)

var lot = document.querySelector('.arr');
